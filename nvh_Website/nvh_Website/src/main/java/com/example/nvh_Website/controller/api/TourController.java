...
import com.example.nvh_Website.dto.ToutStartAddDTO;
import com.example.nvh_Website.entity.Tour;
import com.example.nvh_Website.entity.TourStart;
import com.example.nvh_Website.repository.TourStartRepository;
import com.example.nvh_Website.service.ImageService;
import com.example.nvh_Website.service.TourService;
import com.example.nvh_Website.service.UserService;
import com.example.nvh_Website.utilities.DateUtils;
import com.example.nvh_Website.utilities.FileUploadUtil;
    ...
    public ResponseDTO addImage(@PathVariable("id") Long id,@RequestParam("image") MultipartFile image) {
        ...
        try {
            ...
            if(this.tourService.findTourById(id)!=null) {
                ...
                return new ResponseDTO("Thêm thành công",this.imageService.addTour(id,fileName));
            }
        } catch (IOException  e) {
            // Xử lý exception
            log.info("Lỗi upload file: {}",e.getMessage());
